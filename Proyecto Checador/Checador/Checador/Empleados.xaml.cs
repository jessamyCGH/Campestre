    ...
    public partial class Empleados : Window
    {
        ...
        private void btnFoto_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ofd.ShowDialog() == true)
            {
                ...
                try
                {
                    ...
                    imgFoto.Source = foto;
                    tbUrlFoto.Text = "foto_" + tbCelular.Text + ".jpg";
                }
                catch (Exception ex)
                {
        ...
        private void btnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                empleado.ApellidoP = tbPaterno.Text;
                empleado.ApellidoM = tbMaterno.Text;
                empleado.Correo = tbCorreo.Text;
                empleado.Celular = tbCelular.Text;
                empleado.Club = tbClub.Text;
                ...
                int id = DatoEmpleado.Alta(empleado);
        ...
        private void dgEmpleados_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            tbPaterno.Text = empleado.ApellidoP;
            tbMaterno.Text = empleado.ApellidoM;
            tbCorreo.Text = empleado.Correo;
            tbCelular.Text = empleado.Celular;
            tbClub.Text = empleado.Club;
